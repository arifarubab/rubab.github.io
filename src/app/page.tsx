...
<Layout>
      <section className="hero">
        <div className="justify-evenly textContent text-md mr-44 items-center text-5xl from-transparent">
          <h1 className='font-serif -mt-90' >The Best Store To <br /> Shop Online <br /> All IN ONE</h1>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br /> Proin egestas orci quis mi convallis ipsum.</p>
          <Link href="/Shop" className="bg-black hover:bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg">
              Shop Now
            </Link>
        </div>
